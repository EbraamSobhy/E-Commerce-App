...
import { TbTrash } from "react-icons/tb";
    ...
    return (
        <section className='max_padd_container pt-28'>
                    ...
                    {all_products.map((e) => {
                        if (cartItems[e.id] > 0) {
                            return <tr key={e.id} className='border-b border-slate-900/20 p-6 medium-14 text-center'>
                                <td className='flexCenter'><img src={e.image} alt="" height={43} width={43}
            ...
            <br />
            <div className='flex flex-col gap-20 my-16 p-8 md:flex-row
            rounded-md bg-white w-full max-w-[270px]'>
                <div className='flex flex-col gap-10'>
                    <h4 className='bold-20'>Summary:</h4>
                    <div>
                        <div className='flexBetween py-4'>
                            <h4 className='medium-16'>Subtotal :</h4>
                            <h4 className='text-gray-30 font-semibold'>{getTotalCartAmount()} LE</h4>
                        </div>
                        <hr />
                        {/* <div className='flexBetween py-4'>
                        ...
                        <div className='flexBetween py-4'>
                            ...
                            <h4 className='bold-18'>{getTotalCartAmount()} LE</h4>
                        </div>
                    </div>
                    <div className='flex flex-col gap-10'>
                        <button type='submit' className='btn_dark_rounded w-44'>Submit</button>
                    </div>
                </div>
            </div>
        </section>
