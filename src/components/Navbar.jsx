...
const Navbar = ({ containerStyles }) => {
    return (
        <nav className={containerStyles}>
            ...
            <NavLink to={'/men'} className={({isActive}) => isActive ? "active_link" : ""}><div className='flexCenter gap-x-1'><MdCategory />Men</div></NavLink>
            <NavLink to={'/women'} className={({isActive}) => isActive ? "active_link" : ""}><div className='flexCenter gap-x-1'><MdShop2 />Women</div></NavLink>
