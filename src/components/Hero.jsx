    ...
    return (
        <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full'>
                <div className='max_padd_container relative top-32 xs:top-52'>
                    ...
                    <p className='text-gray-50 regular-16 mt-6 max-w-[33rem]'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Mollitia repellat laboriosam excepturi voluptate nostrum eaque facere sapiente, corporis maxime sint error dolorum sed fuga aliquid esse, iusto ea, id dolor.</p>
